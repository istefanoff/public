...
public class PlantDiscoveryCopy {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            String[] information = scanner.nextLine().split("<->");  //Arnoldii<->4
            plants.put(information[0], new Plant(information[0], Integer.parseInt(information[1])));
        }

        String[] inputs;
        while(!(inputs = scanner.nextLine().split("\\s+"))[0].equals("Exhibition")) {  //Rate: Woodii - 10
